...
return playbleCards[cards.value];
};
...
str = JSON.stringify(carte); 
console.log("pioche une crtes : "  + str);

var playbleCards = cardsPlayable(carte[0].value);
str = JSON.stringify(playbleCards); 
console.log("carte jouable dessus : " + str);
//fin partie test
